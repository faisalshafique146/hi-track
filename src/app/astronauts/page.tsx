...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "See how many astronauts are currently in space and which spacecraft or station they are aboard right now.",
  path: "/astronauts",
  keywords: ["astronauts in space", "who is in space now", "space crew list"],
});
